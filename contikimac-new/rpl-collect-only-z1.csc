...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/app-collect-only.c</source>
      <commands EXPORT="discard">make app-collect-only.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/app-collect-only.z1</firmware>
